...
- [ ] 학생: 본문(코드 또는 zip)·링크 중 최소 1개로 제출 가능, 재제출 시 이력 누적 *(BE 완료 2026-08-26 - FE 제출란 연동 대기)*
- [ ] 마감 경과 제출: 지각으로 표시 *(BE 완료 - FE 배지 연동 대기)*
- [ ] 학생: 자기 제출 상태 확인 가능 *(BE 완료 - FE 연동 대기)*
- [ ] 운영진: 과제별 제출 / 미제출 / 지각 명단 조회 가능 *(BE 현황판 완료 - FE 연동 대기)*
- [ ] 운영진: 제출물 열람 가능 *(BE 완료 - FE 화면 신규 필요)*
