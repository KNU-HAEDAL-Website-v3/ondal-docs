...
| 출석부 | P2 이월 확정 (2026-08-25). **P2 착수(2026-09-14): BE 완료(ondal-BE PR #34 - 차시 Session 부분 승격·출석 표시·출석률 서버 계산, [attendance/design.md](attendance/design.md))**, FE 견본 화면 실 API 교체 진행 | P2 (진행) |
